...
class HashFixer:
    ...
    def try_fix_data(self, data):
        ...
        self.redqueen_state.update_redqueen_whitelist(self.qemu.redqueen_workdir, self.redqueen_state.get_candidate_hash_addrs())
    ...
    def parse_redqueen_results(self, data):
        ...
        run_info = RedqueenRunInfo(1, False, rq_res , "".join(map(chr,data) ) )
